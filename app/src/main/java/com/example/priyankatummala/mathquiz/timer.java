...
public class timer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        timer_view=inflater.inflate(R.layout.fragment_timer, container, false);
        timerValue = (TextView) timer_view.findViewById(R.id.timerValue);
        startTimer();
        return timer_view;
    }
    ...
    public void startTimer(){
        ...
        new CountDownTimer(10000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                timerValue.setText("seconds: " + millisUntilFinished / 1000);
            }
